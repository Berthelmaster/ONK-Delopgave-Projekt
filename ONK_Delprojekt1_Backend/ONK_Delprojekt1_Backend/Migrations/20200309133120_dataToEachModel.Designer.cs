...
namespace ONK_Delprojekt1_Backend.Migrations
{
    ...
    [Migration("20200309133120_dataToEachModel")]
    partial class dataToEachModel
    {
            ...
            modelBuilder.Entity("ONK_Delprojekt1_Backend.Models.Haandvaerker", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HaandvaerkerId = 1,
                            HVAnsaettelsedato = new DateTime(2020, 3, 9, 14, 31, 20, 108, DateTimeKind.Local).AddTicks(2687),
                            HVEfternavn = "Hansen",
            ...
            modelBuilder.Entity("ONK_Delprojekt1_Backend.Models.Vaerktoej", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            VTId = 1L,
                            VTAnskaffet = new DateTime(2020, 3, 9, 14, 31, 20, 116, DateTimeKind.Local).AddTicks(3256),
            ...
            modelBuilder.Entity("ONK_Delprojekt1_Backend.Models.Vaerktoejskasse", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            VTKId = 1,
                            VTKAnskaffet = new DateTime(2020, 3, 9, 14, 31, 20, 117, DateTimeKind.Local).AddTicks(929),
